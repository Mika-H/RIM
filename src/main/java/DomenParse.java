...
public class DomenParse {
   ...
   public DomenParse(String url){
    ...
    public static ArrayList<String> regionVacancy(){
        ...
        ArrayList<String> allVacancy = new ArrayList();
        allVacancy.addAll(ParseRobotaUa.regionSeachVacancy(urlRabotaUa));
    ...
    public static void regionVacancyParse(){
        LinkedHashSet<String> vacancies = new LinkedHashSet<>(regionVacancy());
        LinkedHashSet<String> workUa = DataBase.vacancyFromDb("work.ua");
        LinkedHashSet<String> rabotaUa = DataBase.vacancyFromDb("rabota.ua");
        int temp=vacancies.size();
        vacancies.removeAll(workUa);
        System.out.println("Сверено с базой данных и найдено по сайту work.ua "+(temp-vacancies.size())+" совпадений");
        temp=vacancies.size();
        vacancies.removeAll(workUa);
        System.out.println("Сверено с базой данных и найдено по сайту rabota.ua "+(temp-vacancies.size())+" совпадений");
